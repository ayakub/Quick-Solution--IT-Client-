...
const FAQ = () => {
    return (
        <Container className='mt-5'>
            <Row>
                <Col>
                    <h3 className='text-dark mb-5 text-center'>Which Technology use in project?</h3>
                    <Accordion>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header><h2 className='text-dark'>React</h2></Accordion.Header>
                            <Accordion.Body>
                        ...
                        <Accordion.Item eventKey="1">
                            <Accordion.Header><h2 className='text-dark'>Bootstrap</h2></Accordion.Header>
                            <Accordion.Body>
                        ...
                        <Accordion.Item eventKey="2">
                            <Accordion.Header><h2 className='text-dark'>Node</h2></Accordion.Header>
                            <Accordion.Body>
